...
#window setup/всплывающие окно

window = tkinter.Tk() #create the window/создаем окно
...
def button_clicked(value):
    ...
    if value in right_symbols:
        ...
        if value == ".":
           ...
           label ["text"] = round(result, 1)
       

#center the window / середина окна
window.update() #update window with the new size dimensions/ Обновлять окно под новые размеры
